...
onViewEdit | 点击查看More的回调 | function(tabProps, event) | -
popupVisible | 控制弹层显隐 | boolean | -
locale | 默认文案 | Object | `{ emptyText: 'No notifications', clear: 'Clear', viewEdit: 'Loading more' }`
...
showViewEdit | 是否显示查看More按钮 | boolean | `false`
